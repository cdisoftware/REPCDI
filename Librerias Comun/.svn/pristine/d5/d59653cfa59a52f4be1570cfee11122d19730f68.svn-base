...
namespace CDI.Comun
{
    public class Encriptacion
    {
        ...
        /// <returns></returns>
        private static string Cifrado(string modo, string Algoritmo, string cadena, string key, string VecI)
        {
            Byte[] plaintext;
        ...
        public static string Cifrado(Operacion modo, string cadena)
        {
            try
            {
                ...
                {
                    CDI.Comun.NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Ha ocurrido un error en la clase Encriptacion metodo, Cifrado la cadena viene vacia.", CDI.Comun.NCDITrace.Tipo.Error);
                    return "";
                }
            }
            catch (Exception ex)
            {
                CDI.Comun.NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Ha ocurrido un error en la clase Encriptacion metodo, Cifrado" , ex);
                return "";
            }
        }
    }
