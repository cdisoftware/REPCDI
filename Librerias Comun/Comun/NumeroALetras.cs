...
{
    /// <summary>
    /// Summary description for clsNumLetras
    /// </summary>
    public class NumeroALetras
    {
        ...
        public NumeroALetras(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return NumeroALetras.ToString(Numero, CultureInfo.CurrentCulture);
        }
