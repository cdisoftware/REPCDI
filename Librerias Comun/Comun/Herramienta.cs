...
namespace CDI.Comun
{
    public class Herramienta
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string traerConectionStringMs()
        {
            string strconection = "";
        ...
        public static string traerConectionStringOrcl()
        {
            ...
            try
            {
                ...
                //NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),strconection, NCDITrace.Tipo.Log);
            }
            catch (Exception ex)
            {
                throw new Exception(" Ha ocurrido un error en la recuperacion de los valores de configuracion, metodo traerConectionString. Err " + ex + "Datos: data source=" + Servidor + ";initial catalog=" + BaseDatos +
        ...
        public static string TraerConfiguracion(string key, string pUbicacion)
        {
            ...
            if (File.Exists(pUbicacion))
            {
                ...
                {
                    CDI.Comun.NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "No existe la key buscada, [" + key + "] ", ex);
                    return "";
                }
            }
            return valor;
        ...
        public static string ParseoBase64(string pTxt)
        {
            ...
            {
                CDI.Comun.NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "Error en [ParseoBase64]. Detalle: ", ex);
                return null;
            }
        }
        ...
        public static int ParseoTexto(object pTxt)
        {
            ...
            {
                CDI.Comun.NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "Error en [ParceoTexto]. Detalle: ", ex);
                return -1;
            }
        }
        ...
        public static int ParseoTextoCero(object pTxt)
        {
            ...
            {
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "Error en [ParceoTexto]. Detalle: ", ex);
                return 0;
            }
        }
        ...
        public static int? ParseoTextoANull(object pTxt)
        {
            ...
            {
                CDI.Comun.NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "Error en [ParceoTextoANull]. Detalle: ", ex);
                return -1;
            }
        }
        ...
        public static float ParseoTextoAFloat(object pTxt)
        {
            ...
            {
                CDI.Comun.NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "Error en [ParseoTextoAFloat]. Detalle: ", ex);
                return -1;
            }
        }
        ...
        public static string ReadStringIni(string seccion, string KeyNombre, string nombreArch, string opcional)
        {
            ...
            try
            {
                ...
                {
                    CDI.Comun.NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "No existe el archivo Ini de configuracion, revise la ubicacion en el web.config", CDI.Comun.NCDITrace.Tipo.Error);
                    return opcional;
                }
            }
            catch
        ...
        public static void EnviarMail(string pPara, string pCC, string pAsunto, string pMensaje, List<System.Net.Mail.Attachment> pAdjunto)
        {
            try
            {
                ...
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "ip:" + ip + " port:" + port + " de:" + de + " autenticacion:" + autenticacion, NCDITrace.Tipo.Log);
                ...
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "Listo a enviar pPara:" + pPara + " pCC:" + pCC + " pAsunto:" + pAsunto + " pMensaje:" + pMensaje, NCDITrace.Tipo.Log);
                smtp.Send(mail);
                mail.Dispose();
            }
            catch (Exception ex)
        ...
        /// <param name="pMensaje">El cuerpo del mensaje</param>
        /// <param name="pAdjunto">Archivo adjuntos</param>
        public static void EnviarMail(string pPara, string pCC, string pAsunto, string pMensaje, List<System.Net.Mail.Attachment> pAdjunto, bool Ssl)
        {
            try
            {
                string ip = Encriptacion.Cifrado(Encriptacion.Operacion.Desencripta, (TraerConfiguracion("smtpServer")));
        ...
        public static void EnviarMailPlantilla(string pPara, string pCC, string pAsunto, string pMensaje, List<System.Net.Mail.Attachment> pAdjunto, Page page)
        {
            try
            {
                ...
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "pPara:" + pPara + " pCC:" + pCC + " pAsunto:" + pAsunto + " pMensaje:" + pMensaje, NCDITrace.Tipo.Log);
                smtp.Send(mail);
                mail.Dispose();
            }
            catch (Exception ex)
        ...
        #endregion Eliminar Caracteres especiales
        ...
        public static string ValorForm(HttpRequest request, string campo)
        {
            ...
            {
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "No se puede recuperar el valor del campo [" + campo + "] pagina[" + request.FilePath + "]", NCDITrace.Tipo.Log);
                return null;
            }
        }
        ...
        public static string ValorQuery(HttpRequest request, string campo)
        {
            ...
            {
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "No se puede recuperar el valor del querystring [" + campo + "] pagina[" + request.FilePath + "]", NCDITrace.Tipo.Log);
                return null;
            }
        }

        #endregion Ayudas WEB

        #region Utilidades

        //Adiciona Robinson Yepes Rivera - CDI Software
        /// <summary>
        /// Valida si la información capturada es nula 0 el valor es -1
        /// </summary>
        /// <param name="validarString"></param>
        /// <returns></returns>
        private static bool EsStringNotNullEmpty(string validarString)
        {
            return (!string.IsNullOrEmpty(validarString) && !validarString.Equals("0") && !validarString.Equals("-1"));
        }

        /// <summary>
        /// Validar nulo o vacio
        /// </summary>
        /// <param name="datoAValidar"></param>
        /// <returns></returns>
        public static bool ValidarNotEmptyNull(object datoAValidar)
        {
            if (datoAValidar == null)
                return false;

            if (datoAValidar is ListItem)
                return EsStringNotNullEmpty(string.Format("{0}", (datoAValidar as ListItem).Value));

            if (datoAValidar is string)
                return EsStringNotNullEmpty(datoAValidar as string);
        ...
        /// <returns></returns>
        public static int? ObtenerValorInt(string datoValidar)
        {
            if (!string.IsNullOrEmpty(datoValidar))
            {
                int valor = 0;
                if (int.TryParse(datoValidar, out valor))
                    return valor;
                else
                {
                    valor = -1;
        ...
        /// <summary>
        /// Obtiene el valor de un label
        /// </summary>
        /// <param name="lblControl"></param>
        /// <returns></returns>
        public static string ObtenerValorIntLabel(Label lblControl)
        {
            if (!ValidarNotEmptyNull(lblControl.Text))
                return null; //Dato vacío

            return lblControl.Text;
        }

        /// <summary>
        /// Obtiene el valor seleccionado de un DropDownList
        /// </summary>
        /// <param name="cbControl"></param>
        /// <returns></returns>
        public static string ObtenerValorSeleccionado(DropDownList cbControl)
        {
            if (!ValidarNotEmptyNull(cbControl.SelectedValue))
                return null; //Dato vacío

            return cbControl.SelectedValue;
        }

        /// <summary>
        /// Obtiene el valor seleccionado de una grilla
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        /// <returns></returns>
        public static int ObtenerGridViewIndex(object sender, GridViewCommandEventArgs e)
        {
            int index = 1;
        ...
        public static void LogValorConsultaSQL(DataTable dt)
        {
            try
            {
                if (dt != null)
                {
                    NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "LogValorConsultaSQL NombreTabla: " + dt.TableName + " Filas: " + dt.Rows.Count, NCDITrace.Tipo.Log);
                    int posicion = 0;
                    foreach (DataRow dr in dt.Rows)
                    {
                        NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "Fila Numero: " + posicion, NCDITrace.Tipo.Log);
                        foreach (DataColumn dc in dt.Columns)
                        {
                            ...
                            NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "Columna [" + Nombre + "] Valor: " + Valor, NCDITrace.Tipo.Log);
                        }
            ...
            {
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(), "LogValorConsultaSQL Error: ", ex);
            }
        }
