...
namespace CDI.Comun
{
    ...
    public class ActiveDirectory
    {
        ...
        public bool ValidacionUsuario(string clave, string usuario)
        {
            ...
            NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Ingreso a ValidacionUsuario: Usuario: " + usuario, NCDITrace.Tipo.Log);
            string adPath = Herramienta.TraerConfiguracion("PathLDAP"); ;
            NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Path: " + adPath, NCDITrace.Tipo.Log);
            try
            {
                ...
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Dominio: " + domain, NCDITrace.Tipo.Log);
                string domainAndusuario = domain + @"\" + usuario;
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Dominio y Usuario: " + domainAndusuario, NCDITrace.Tipo.Log);

                DirectoryEntry entry = new DirectoryEntry(adPath, domainAndusuario, clave);
                try
                {
                    NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Directorio Activo: NativeObject", NCDITrace.Tipo.Log);
                ...
                {
                    NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Error en ValidacionUsuario contra el directorio activo. " + e.Message, NCDITrace.Tipo.Log);
                    return false;
                }
            }
            catch (Exception ex)
        ...
        public bool ValidacionUsuario(string clave, string usuario, string UsuarioBusqueda)
        {
            ...
            NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Ingreso a ValidacionUsuario: Usuario: " + usuario + " UsuarioBusqueda: " + UsuarioBusqueda, NCDITrace.Tipo.Log);
            ...
            {
                NCDITrace.EscribirLog(System.Reflection.MethodBase.GetCurrentMethod(),"Error en ValidacionUsuario 2 contra el directorio activo. " + e.Message, NCDITrace.Tipo.Log);
